    ...
    def forward(self,input, label):
        ...
        for batch_id in range(batch_size):
            ...
            if len(pos_index) > 0:
               ...
               if neg_idx2.sum()==0:
                    continue
               num_neg=len(neg_prob[neg_idx2]) #硬负样本的数量
